# This file is a copy of infer-web.py from Mangio-RVC, with some changes to make it possible to do huge automated batch of inference on bunch of models sequentially.
# To use this file, you must first install the Mangio-RVC. Then copy this file into the directory of the project, before running it with "runtime/python.exe custom_batch_inference.py" in cmd
...
def load_hubert():
    ...
    # print(f"config.half: {config.half}")
...
def vc_single(
    ...
    try:
        print(f"DoFormant: {DoFormant}")
        print(f"Quefrency: {Quefrency}")
...
def vc_multi(
    ...
    print(f"crepe_hop_length: {crepe_hop_length}")
    print(f"------------------------------------")
    # try:
    dir_path = (
    ...
    for path in paths:
        ...
        print("%s->%s" % (os.path.basename(path), info))
    return "\n".join(infos)
    # except:
...
# 一个选项卡全局只能有一个音色
# use get_vc with "Arthur_Morgan.pth" as first param and
# 0.33 for second to return protect1 
def get_vc(sid, to_return_protect0, to_return_protect1):
    print(f"sid: {sid}")
    print(f"to_return_protect0: {to_return_protect0}")
    print(f"to_return_protect1: {to_return_protect1}")
...
# my custom batch inference




targetSpeakers = ["Anya"] #["Arthur_Morgan", "Blitz_Helluva_Boss", "Dutch_van_der_Linde", "Loona_Helluva_Boss", "Stolas_Helluva_Boss", "Vestia_Zeta"]
sourceSpeakers = ["SPEAKER0001","SPEAKER0002","SPEAKER0006","SPEAKER0007","SPEAKER0098","SPEAKER0099","SPEAKER0100","SPEAKER0101"]
# 	0001	0002	0006	0007	0098	0099	0100	0101
# Arthur_Morgan	-8	-11	-2	-1	1	-5	-6	-5
# Dutch_van_der_Linde	-7	-10	-1	0	2	-4	-5	-4
# Blitz_Helluva_Boss	-5	-8	1	2	4	-2	-3	-2
# Loona_Helluva_Boss	-2	-5	4	5	7	1	0	1
# Stolas_Helluva_Boss	-4	-7	2	3	5	-1	-2	-1
# Vestia_Zeta	3	0	9	10	12	6	5	6
pitchContainer = [
    [5, 2, 11, 12, 14, 8, 7, 8]
    # [-8, -11, -2, -1, 1, -5, -6, -5]
    # ,[-7, -10, -1, 0, 2, -4, -5, -4]
...
for targetCount, targetSpeaker in enumerate(targetSpeakers):
    get_vc(f"{targetSpeaker}.pth", 0.33, 0.33)
    
    for sourceCount, sourceSpeaker in enumerate(sourceSpeakers):
        val = vc_multi(0, 
                f"C:/Users/jazzt/Desktop/CCA/Deepfake_Audio_Detection/Mangio-RVC-v23.7.0_INFER_TRAIN/Mangio-RVC/audios/SpoofedTargetSpeech/{sourceSpeaker}",
                f"opt/{targetSpeaker}/{sourceSpeaker}",
                None,
                pitchContainer[targetCount][sourceCount],
                "rmvpe",
                "",
                f"./logs/indexes/{targetSpeaker}.index",
                1,
                7,
                0,
                1,
...
# ------------------------------------
# sid: 0
# dir_path: C:/Users/jazzt/Desktop/CCA/Deepfake_Audio_Detection/Mangio-RVC-v23.7.0_INFER_TRAIN/Mangio-RVC/audios/SpoofedTargetSpeech/SPEAKER0001
# opt_root: opt/Blitz_Helluva_Boss/SPEAKER0001
# paths: None
# f0_up_key: 5.0
# f0_method: rmvpe
# file_index:
# file_index2: ./logs/indexes/Arthur_Morgan.index
# index_rate: 1
# filter_radius: 7
# resample_sr: 0
# rms_mix_rate: 1
